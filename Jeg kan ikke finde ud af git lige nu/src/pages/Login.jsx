    ...
    return (
        <section>
            ...
            <form onSubmit={ handleLogin }>
                ...
                <div className="m-4">
                    <input type="text" name="inpIdentity" placeholder='Brugernavn eller email (identity)' className="w-1/2 border border-white input" />
                </div>


                <div className="m-4">

                    <input type="password" name="inpPW" placeholder='Password' className="w-1/2 border border-white input" />
